...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    /* Base */
     [0] = LAYOUT(
           ...
           KC_A,    KC_R,    KC_S,    KC_T,   KC_G,         KC_M,    KC_N,    KC_E,       KC_I,    KC_O,
                  _C(KC_X),_S(KC_C),_G(KC_D),  KC_V,        KC_K, _G(KC_H),_S(KC_COMM),_C(KC_DOT),
                           _A(KC_Z),  LT(3,KC_CAPS), LT(1,KC_BSPC),LT(2,KC_SPC), LT(4,KC_ENT),_A(KC_SLSH)
    )
    ...
    [1] = LAYOUT(
        ...
        KC_TAB,  CUT,     COPY,    PSTE,    KC_ENT,  KC_MINS, KC_P4,   KC_P5,   KC_P6,   KC_PAST,
                 WKSPLF,  MSNCTL,  WKSPRT,  KC_SPC,  KC_DLR,  KC_P1,   KC_P2,   KC_P3,
                         _______, _______, XXXXXXX,  KC_P0,   KC_PDOT,  KC_PSLS
    ),
    [2] = LAYOUT(
        ...
        KC_EXLM, KC_AT,   KC_HASH, KC_LPRN, KC_RPRN, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,
         KC_AMPR, KC_PIPE, KC_LBRC, KC_RBRC, KC_CAPS, KC_PGDN, _______,  _______,
                           KC_BSLS, _______, KC_DEL,  XXXXXXX, _______,_______
    ),
    [3] = LAYOUT(
        ...
        _______, _______, REDO,    UNDO,    _______, KC_MINS, KC_PEQL, KC_DQUO, KC_QUOT, _______,
                 _______, _______, _______, _______, _______, _______, KC_LABK, KC_RABK,
    ...
    [4] = LAYOUT(
       ...
       _______, _______, _______, _______, _______, _______, KC_BRID, KC_VOLD, ZOOMOUT, _______,
                _______, _______, _______, _______, _______, _______, _______, ACTUAL,
